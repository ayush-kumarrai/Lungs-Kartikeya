...
const MedicalReportAnalyzer = () => {
  ...
  const styles = {
    mainn:{
      ...
      minHeight: '94vh', // Ensures it covers at least the viewport height
      height: 'auto', // Allows it to grow dynamically if content exceeds 100vh
      display:'flex',
    ...
    h1: {
      ...
      fontFamily: "Anton",
      marginBottom: '20px',
      textShadow: '2px 2px 8px rgba(0, 0, 0, 0.2)', // Subtle shadow to make it pop
      textTransform: 'uppercase', // Capitalize the text for a clean look
      lineHeight: '1.2', // Line height to make it more readable
    }, 
    container: {
  ...
  return (
    <div style={styles.mainn}>
     ...
     <div style={styles.container}>
      <h1  style={styles.h1} >Medical Report Analyzer</h1>
